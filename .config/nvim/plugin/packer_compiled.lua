...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["vim-js-arrow-function"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/vim-js-arrow-function",
    url = "https://github.com/mvolkmann/vim-js-arrow-function"
  }
}
